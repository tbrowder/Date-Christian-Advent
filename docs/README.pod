...
Note: Methods 1 and 2 were suggested by author of the bug report
filed with the Perl CPAN module C<DateTime::Calendar::Liturgical::Christian>
which was the inspiration for this module.
